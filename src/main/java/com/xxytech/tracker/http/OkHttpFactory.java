...
import com.xxytech.tracker.constants.OkHttpConstants;
import com.xxytech.tracker.exception.TrackerRuntimeException;
import com.xxytech.tracker.utils.StringUtils;
...
public class OkHttpFactory {
    ...
    public Response get(String url) throws TrackerRuntimeException {
        return get(url, new HttpHeaders());
    }

    public Response get(String url, HttpHeaders headers) throws TrackerRuntimeException {
        Request.Builder requestBuilder = new Request.Builder().get().url(url);
        return send(requestBuilder, Headers.of(headers.getHeaders()));
    }

    public Response post(String url, byte[] body, HttpHeaders headers) throws TrackerRuntimeException {
        return post(url, body, headers, OkHttpConstants.STREAM_MIME);
    }

    public Response post(String url, String body, HttpHeaders headers) throws TrackerRuntimeException {
        return post(url, StringUtils.utf8Bytes(body), headers, OkHttpConstants.STREAM_MIME);
    }

    public Response post(String url, HttpFormEncoding params, HttpHeaders headers) throws TrackerRuntimeException {
    ...
    public Response post(String url, byte[] body, HttpHeaders headers, String contentType) throws TrackerRuntimeException {
        RequestBody rbody;
    ...
    public Response post(String url, byte[] body, int offset, int size, HttpHeaders headers,
                         String contentType) throws TrackerRuntimeException {
        RequestBody rbody;
        if (body != null && body.length > 0) {
            MediaType t = MediaType.parse(contentType);
    ...
    public Response post(String url, InputStream inputStream, Long contentLength,
                         HttpHeaders headers) throws TrackerRuntimeException {
        return post(url, requestIO(inputStream, contentLength), headers);
    }

    public Response post(String url, RequestBody body, HttpHeaders headers) throws TrackerRuntimeException {
        Request.Builder requestBuilder = new Request.Builder().url(url).post(body);
        return send(requestBuilder, Headers.of(headers.getHeaders()));
    }

    public Response put(String url, HttpHeaders headers) throws TrackerRuntimeException {
        return put(url, emptyRequestBody, headers);
    }

    public Response put(String url, Object body, HttpHeaders headers) throws TrackerRuntimeException {
        return put(url, JSONObject.toJSONString(body), headers);
    }

    public Response put(String url, String body, HttpHeaders headers) throws TrackerRuntimeException {
    ...
    private Response put(String url, RequestBody body, HttpHeaders headers) throws TrackerRuntimeException {
        Request.Builder requestBuilder = new Request.Builder().url(url).put(body);
        return send(requestBuilder, Headers.of(headers.getHeaders()));
    }

    public Response delete(String url) throws TrackerRuntimeException {
        return delete(url, new HttpHeaders());
    }

    public Response delete(String url, HttpHeaders headers) throws TrackerRuntimeException {
        Request.Builder requestBuilder = new Request.Builder().url(url).delete();
        return send(requestBuilder, Headers.of(headers.getHeaders()));
    }

    public Response send(final Request.Builder requestBuilder, Headers headers) throws TrackerRuntimeException {
        if (headers != null) {
        ...
        try {
            ...
            if (response.code() >= 300) {
                throw new TrackerRuntimeException(response.code() + "::" + response.message());
            }
            return response;
        } catch (IOException e) {
            throw new TrackerRuntimeException(e.getMessage(), e);
        }
    }
